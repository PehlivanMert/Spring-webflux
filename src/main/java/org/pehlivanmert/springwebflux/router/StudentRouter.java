...
public class StudentRouter {
    ...
    /**
     * This method defines a router function that handles the GET request to the "/v1/student/courses" endpoint.
     * It uses the StudentHandler to handle the request and return a response.
     *
     * @return RouterFunction<ServerResponse> - The router function for handling student courses requests.
     */
    @Bean
    @RouterOperations(
            @RouterOperation(
